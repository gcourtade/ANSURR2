...
def main(argument_string=""):
    ...
    parser.add_argument("-j", "--javapath", type=str, help="User-defined JAVA path for PANAV")
    ...
    path_to_java = args.javapath # need to check that file looks like a PDB file
    ...
    set_chain_output_rci = rci_nef.calc_RCI(path_to_shifts,output_dir+'/other_output/',path_to_java, panav=args.reref,quiet=args.quiet)
